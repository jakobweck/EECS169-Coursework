...
public class GameDriver {
	...
	public static void main(String[] args) {
		String guess;
		char guessChar;
		String secret = "big bang";
		boolean guessSuccess = false;
		boolean wordGuessed = false;
		boolean wordGuessAllowedTemp = false;
		...
		while (playAgain == true){
			...
			while (game.isGameOver() == false){
				...
				//else guess as a full word if word guesses are still allowed
					...
					wordGuessed = true; 
					wordGuessAllowedTemp = game.areWordGuessesAllowed();
				...
				else if (guessSuccess == true && wordGuessed == true && wordGuessAllowedTemp){
					System.out.println(guess + " is the secret word!");
				}
				else if (guessSuccess == false && wordGuessed == true && wordGuessAllowedTemp){
					System.out.println(guess + " is not the secret word. You've used your one full-word guess!");
				}
				else if (!wordGuessAllowedTemp){
