 ...
 * Homework Assignment Number: 1-1
 * Description: Simulates ordering various quantities of bananas, calculates prices
 * Last Changed: 9/21/2015
 */
import java.util.Scanner;

public class BananaStand1 {
	...
	public static void main(String[] args) {
		...
		// calculate/print total cost after markups/discount
		double total_cost = base_cost + total_markup - total_discount;
